<template>
    <v-card>
        <v-toolbar dark color="success">
            ...
            <v-text-field v-model="keyword" @input="doSearch" hide-details append-icon="mic" text label="Search" prepend-inner-icon="search" solo-inverted ref="textSearch"></v-text-field>
        </v-toolbar>
        <v-divider></v-divider>

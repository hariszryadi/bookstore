    ...
    <v-card>
        ...
        <v-container fluid>
            <v-form ref="form" v-model="valid" lazy-validation>
                ...
                :type="showPassword ? 'text' : 'password'" label="Password" hint="At least 6 characters" counter @click:append="showPassword = !showPassword"></v-text-field>
                <div class="text-xs-center">
                    <v-btn color="green accent-2" :disabled="!valid" @click="submit">
                        Login <v-icon dark>lock_open</v-icon>
                    </v-btn>
                </div>
            </v-form>
        </v-container>
